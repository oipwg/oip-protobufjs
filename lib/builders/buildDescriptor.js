...
const descriptorPackage = 'oipProto.templates'; // const Txid = ProtoModules.oipProto.Txid
...
function buildDescriptor(fieldData) {
  ...
  const Txid = new _protobufjs.default.Type('Txid').add(new _protobufjs.default.Field('raw', 1, 'bytes')); // let tRoot = new protobuf.Root()
