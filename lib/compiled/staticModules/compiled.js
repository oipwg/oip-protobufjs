  ...
  $root.oipProto = function () {
    ...
    oipProto.HistorianDataPoint = function () {
      ...
      HistorianDataPoint.encode = function encode(message, writer) {
        ...
        if (message.PubKey != null && message.hasOwnProperty("PubKey")) writer.uint32(
        /* id 2, wireType 2 =*/
        18).bytes(message.PubKey);
        if (message.MiningRigRentalsLast10 != null && message.hasOwnProperty("MiningRigRentalsLast10")) writer.uint32(
        /* id 3, wireType 1 =*/
        25).double(message.MiningRigRentalsLast10);
        if (message.MiningRigRentalsLast24Hr != null && message.hasOwnProperty("MiningRigRentalsLast24Hr")) writer.uint32(
        /* id 4, wireType 1 =*/
        33).double(message.MiningRigRentalsLast24Hr);
        if (message.AutominerPoolHashrate != null && message.hasOwnProperty("AutominerPoolHashrate")) writer.uint32(
        /* id 5, wireType 1 =*/
        41).double(message.AutominerPoolHashrate);
        if (message.FloNetHashRate != null && message.hasOwnProperty("FloNetHashRate")) writer.uint32(
        /* id 6, wireType 1 =*/
        49).double(message.FloNetHashRate);
        if (message.FloMarketPriceBTC != null && message.hasOwnProperty("FloMarketPriceBTC")) writer.uint32(
        /* id 7, wireType 1 =*/
        57).double(message.FloMarketPriceBTC);
        if (message.FloMarketPriceUSD != null && message.hasOwnProperty("FloMarketPriceUSD")) writer.uint32(
        /* id 8, wireType 1 =*/
        65).double(message.FloMarketPriceUSD);
        if (message.LtcMarketPriceUSD != null && message.hasOwnProperty("LtcMarketPriceUSD")) writer.uint32(
        /* id 9, wireType 1 =*/
        73).double(message.LtcMarketPriceUSD);
        if (message.NiceHashLast != null && message.hasOwnProperty("NiceHashLast")) writer.uint32(
        /* id 10, wireType 1 =*/
        81).double(message.NiceHashLast);
        if (message.NiceHash24hr != null && message.hasOwnProperty("NiceHash24hr")) writer.uint32(
        /* id 11, wireType 1 =*/
    ...
    oipProto.MultiPart = function () {
      ...
      MultiPart.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.currentPart != null && message.hasOwnProperty("currentPart")) writer.uint32(
        /* id 1, wireType 0 =*/
        8).uint32(message.currentPart);
        if (message.countParts != null && message.hasOwnProperty("countParts")) writer.uint32(
        /* id 2, wireType 0 =*/
        16).uint32(message.countParts);
        if (message.rawData != null && message.hasOwnProperty("rawData")) writer.uint32(
        /* id 3, wireType 2 =*/
        26).bytes(message.rawData);
        if (message.reference != null && message.hasOwnProperty("reference")) $root.oipProto.Txid.encode(message.reference, writer.uint32(
        /* id 4, wireType 2 =*/
        34).fork()).ldelim();
        return writer;
      };
    ...
    oipProto.Txid = function () {
      ...
      Txid.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.raw != null && message.hasOwnProperty("raw")) writer.uint32(
        /* id 1, wireType 2 =*/
    ...
    oipProto.NormalizeRecordProto = function () {
      ...
      NormalizeRecordProto.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.mainTemplate != null && message.hasOwnProperty("mainTemplate")) writer.uint32(
        /* id 1, wireType 0 =*/
    ...
    oipProto.Field = function () {
      ...
      Field.encode = function encode(message, writer) {
        ...
        if (message.template != null && message.hasOwnProperty("template")) writer.uint32(
        /* id 3, wireType 0 =*/
    ...
    oipProto.OipFive = function () {
      ...
      OipFive.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.recordTemplate != null && message.hasOwnProperty("recordTemplate")) $root.oipProto.RecordTemplateProto.encode(message.recordTemplate, writer.uint32(
        /* id 1, wireType 2 =*/
        10).fork()).ldelim();
        if (message.record != null && message.hasOwnProperty("record")) $root.oipProto.RecordProto.encode(message.record, writer.uint32(
        /* id 2, wireType 2 =*/
        18).fork()).ldelim();
        if (message.normalize != null && message.hasOwnProperty("normalize")) $root.oipProto.NormalizeRecordProto.encode(message.normalize, writer.uint32(
        /* id 3, wireType 2 =*/
        26).fork()).ldelim();
        if (message.transfer != null && message.hasOwnProperty("transfer")) $root.oipProto.Transfer.encode(message.transfer, writer.uint32(
        /* id 7, wireType 2 =*/
        58).fork()).ldelim();
        if (message.deactivate != null && message.hasOwnProperty("deactivate")) $root.oipProto.Deactivate.encode(message.deactivate, writer.uint32(
        /* id 8, wireType 2 =*/
        66).fork()).ldelim();
        if (message.edit != null && message.hasOwnProperty("edit")) $root.oipProto.Edit.encode(message.edit, writer.uint32(
        /* id 9, wireType 2 =*/
        74).fork()).ldelim();
        return writer;
      };
    ...
    oipProto.RecordProto = function () {
      ...
      RecordProto.encode = function encode(message, writer) {
        ...
        if (message.payment != null && message.hasOwnProperty("payment")) $root.oipProto.Payment.encode(message.payment, writer.uint32(
        /* id 6, wireType 2 =*/
        50).fork()).ldelim();
        if (message.details != null && message.hasOwnProperty("details")) $root.oipProto.OipDetails.encode(message.details, writer.uint32(
        /* id 7, wireType 2 =*/
        58).fork()).ldelim();
        if (message.permissions != null && message.hasOwnProperty("permissions")) $root.oipProto.Permissions.encode(message.permissions, writer.uint32(
        /* id 8, wireType 2 =*/
        66).fork()).ldelim();
        return writer;
      };
    ...
    oipProto.RecordTemplateProto = function () {
      ...
      RecordTemplateProto.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.friendlyName != null && message.hasOwnProperty("friendlyName")) writer.uint32(
        /* id 1, wireType 2 =*/
        ...
        if (message.DescriptorSetProto != null && message.hasOwnProperty("DescriptorSetProto")) writer.uint32(
        /* id 4, wireType 2 =*/
        34).bytes(message.DescriptorSetProto);
        if (message.identifier != null && message.hasOwnProperty("identifier")) writer.uint32(
        /* id 10, wireType 1 =*/
        81).sfixed64(message.identifier);
        ...
        if (message["extends"] != null && message["extends"].length) {
          ...
          for (var i = 0; i < message["extends"].length; ++i) writer.sfixed64(message["extends"][i]);
          ...
          switch (tag >>> 3) {
            ...
            case 12:
              ...
              if ((tag & 7) === 2) {
                ...
                while (reader.pos < end2) message["extends"].push(reader.sfixed64());
              } else message["extends"].push(reader.sfixed64());
      ...
      RecordTemplateProto.verify = function verify(message) {
        ...
        if (message["extends"] != null && message.hasOwnProperty("extends")) {
          ...
          for (var i = 0; i < message["extends"].length; ++i) if (!$util.isInteger(message["extends"][i]) && !(message["extends"][i] && $util.isInteger(message["extends"][i].low) && $util.isInteger(message["extends"][i].high))) return "extends: integer|Long[] expected";
        }

        if (message.identifier != null && message.hasOwnProperty("identifier")) if (!$util.isInteger(message.identifier) && !(message.identifier && $util.isInteger(message.identifier.low) && $util.isInteger(message.identifier.high))) return "identifier: integer|Long expected";
        return null;
      };
      /**
      ...
      RecordTemplateProto.fromObject = function fromObject(object) {
        ...
        if (object["extends"]) {
          ...
          for (var i = 0; i < object["extends"].length; ++i) if ($util.Long) (message["extends"][i] = $util.Long.fromValue(object["extends"][i])).unsigned = false;else if (typeof object["extends"][i] === "string") message["extends"][i] = parseInt(object["extends"][i], 10);else if (typeof object["extends"][i] === "number") message["extends"][i] = object["extends"][i];else if (typeof object["extends"][i] === "object") message["extends"][i] = new $util.LongBits(object["extends"][i].low >>> 0, object["extends"][i].high >>> 0).toNumber();
        }
      ...
      RecordTemplateProto.toObject = function toObject(message, options) {
        ...
        if (message["extends"] && message["extends"].length) {
          ...
          for (var j = 0; j < message["extends"].length; ++j) if (typeof message["extends"][j] === "number") object["extends"][j] = options.longs === String ? String(message["extends"][j]) : message["extends"][j];else object["extends"][j] = options.longs === String ? $util.Long.prototype.toString.call(message["extends"][j]) : options.longs === Number ? new $util.LongBits(message["extends"][j].low >>> 0, message["extends"][j].high >>> 0).toNumber() : message["extends"][j];
        }
    ...
    oipProto.SignedMessage = function () {
      ...
      SignedMessage.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.SerializedMessage != null && message.hasOwnProperty("SerializedMessage")) writer.uint32(
        /* id 1, wireType 2 =*/
        10).bytes(message.SerializedMessage);
        if (message.MessageType != null && message.hasOwnProperty("MessageType")) writer.uint32(
        /* id 2, wireType 0 =*/
        16).int32(message.MessageType);
        if (message.SignatureType != null && message.hasOwnProperty("SignatureType")) writer.uint32(
        /* id 3, wireType 0 =*/
    ...
    oipProto.templates = function () {
      ...
      templates.tmpl_000000000000F113 = function () {
        ...
        tmpl_000000000000F113.encode = function encode(message, writer) {
          ...
          if (message.filePath != null && message.hasOwnProperty("filePath")) writer.uint32(
          /* id 2, wireType 2 =*/
          18).string(message.filePath);
          if (message.size != null && message.hasOwnProperty("size")) writer.uint32(
          /* id 3, wireType 0 =*/
          24).uint64(message.size);
          if (message.contentType != null && message.hasOwnProperty("contentType")) writer.uint32(
          /* id 4, wireType 2 =*/
          34).string(message.contentType);
          if (message.network != null && message.hasOwnProperty("network")) writer.uint32(
          /* id 5, wireType 0 =*/
          40).int32(message.network);
          if (message.location != null && message.hasOwnProperty("location")) writer.uint32(
          /* id 6, wireType 2 =*/
        ...
        tmpl_000000000000F113.decode = function decode(reader, length) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
          var end = length === undefined ? reader.len : reader.pos + length,
              message = new $root.oipProto.templates.tmpl_000000000000F113();
        ...
        tmpl_000000000000F113.fromObject = function fromObject(object) {
          if (object instanceof $root.oipProto.templates.tmpl_000000000000F113) return object;
      ...
      templates.tmpl_00000000000BA51C = function () {
        ...
        tmpl_00000000000BA51C.encode = function encode(message, writer) {
          ...
          /* id 2, wireType 2 =*/
          18).string(message.description);
          if (message.year != null && message.hasOwnProperty("year")) writer.uint32(
          /* id 3, wireType 0 =*/
        ...
        tmpl_00000000000BA51C.decode = function decode(reader, length) {
          if (!(reader instanceof $Reader)) reader = $Reader.create(reader);
          var end = length === undefined ? reader.len : reader.pos + length,
              message = new $root.oipProto.templates.tmpl_00000000000BA51C();
        ...
        tmpl_00000000000BA51C.fromObject = function fromObject(object) {
          if (object instanceof $root.oipProto.templates.tmpl_00000000000BA51C) return object;
