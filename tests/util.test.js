...
describe('util', () => {
  describe('template builder type checking', () => {
    it('check type conversion for _extends param', () => {
      let _extends = [-2219827213574532400, '-3,271,754,646,568,989,696', '5,567,828,826,582,331,392']
      ...
      expect(_extends).toEqual([-2219827213574532400, -3271754646568989696, 5567828826582331392])
